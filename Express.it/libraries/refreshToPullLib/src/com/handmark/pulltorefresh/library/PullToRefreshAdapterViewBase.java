...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
    ...
    public enum MoreItemScrollState {
    	MORE_ITEM_SCROLL_MID_POINT,
    	MORE_ITEM_SCROLL_END_POINT
    }
	...
	private MoreItemScrollState mMoreItemScrollState;
	...
	public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
		...
		if (null != mOnLastItemVisibleListener) {
			int threshold = totalItemCount - 1;	// by default last item.
			
			if (this.getMoreItemScrollState() == MoreItemScrollState.MORE_ITEM_SCROLL_MID_POINT) {
				threshold = totalItemCount / 2;	// mid point.
			}

			mLastItemVisible = (totalItemCount > 0) && (firstVisibleItem + visibleItemCount >= threshold);
		}
	...
	public MoreItemScrollState getMoreItemScrollState() {
		return mMoreItemScrollState;
	}

	public void setMoreItemScrollState(MoreItemScrollState moreItemScrollState) {
		this.mMoreItemScrollState = moreItemScrollState;
	}
}
